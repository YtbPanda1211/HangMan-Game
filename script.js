...
let options = {
  ...
  countries: [
    "Azerbaijan","Guinea","Nepal",
    "Bahamas","Guyana","Netherlands",
    "Bahrain","Haiti","Nicaragua",
    "Bangladesh","Honduras","Niger",
    "Barbados","Hungary","Nigeria	",
    "Belarus","Iceland","Korea",
    "Belgium","India","Macedonia",
    "Belize","Indonesia","Norway",
    "Benin","Iran","Oman",
    "Bhutan","Iraq","Pakistan	",
    "Bolivia","Ireland","Palau",
    "Botswana","Israel","Panama",
    "Brazil","Italy","Paraguay",
    "Brunei","Jamaica","Peru",
    "Bulgaria","Japan","Philippines",
    "Burundi","Jordan","Poland",
    "Cambodia","Kazakhstan","Portugal",
    "Cameroon","Kenya","Qatar",
    "Canada","Kiribati","Romania",
    "Chad","Kuwait","Russia",
    "Chile","Kyrgyzstan","Rwanda",
    "China","Laos","Samoa",
    "Colombia","Latvia","Senegal",
    "Comoros","Lebanon","Serbia",
    "Congo ","Lesotho","Seychelles",
    "Croatia","Liberia","Singapore",
    "Cuba","Libya","Slovakia",
    "Cyprus","Liechtenstein","Slovenia",
    "Czechia ","Lithuania","Islands",
    "Denmark","Luxembourg","Somalia",
    "Djibouti","Madagascar","Spain",
    "Dominica","Malawi","Sudan",
    "Ecuador","Malaysia","Suriname",
    "Egypt","Maldives","Sweden",
    "Eritrea","Mali","Switzerland",
    "Estonia","Malta","Syria",
    "Ethiopia","Mauritius","Tajikistan",
    "Fiji","Mexico","Tanzania",
    "Finland","Micronesia","Thailand",
    "France","Moldova","Togo",
    "Gabon","Monaco","Tonga",
    "Gambia","Mongolia","Tunisia",
    "Georgia","Montenegro","Turkey",
    "Germany","Morocco","Turkmenistan",
    "Ghana","Mozambique","Tuvalu",
    "Greece","Myanmar ","Uganda",
    "Grenada","Namibia","Ukraine",
    "Guatemala","Nauru","US","UK",
